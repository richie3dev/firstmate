...
- [docs/state-inventory.md](docs/state-inventory.md) - the exhaustive per-file inventory of an operational home: what wrote each `data/`, `state/`, and `config/` entry and whether it is yours to touch.
